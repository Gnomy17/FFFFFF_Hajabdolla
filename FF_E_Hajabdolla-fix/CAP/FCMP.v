...
//altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix II" PIPELINE=3 WIDTH_EXP=8 WIDTH_MAN=23 aclr aeb alb clk_en clock dataa datab
...
endmodule //FCMP_altfp_compare_ghc
//VALID FILE
...
module FCMP (
	...
	FCMP_altfp_compare_ghc	FCMP_altfp_compare_ghc_component (
				.dataa (dataa),
				.datab (datab),
				.clk_en (clk_en),
				.clock (clock),
