...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix II" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa nan overflow result underflow
//VERSION_BEGIN 9.0 cbx_altbarrel_shift 2008:08:28:01:40:10:SJ cbx_altfp_convert 2008:09:12:02:56:42:SJ cbx_altpriority_encoder 2008:05:19:11:01:44:SJ cbx_altsyncram 2008:11:06:10:05:41:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_abs 2008:05:19:10:51:43:SJ cbx_lpm_add_sub 2008:12:09:22:11:50:SJ cbx_lpm_compare 2009:02:03:01:43:16:SJ cbx_lpm_decode 2008:05:19:10:39:27:SJ cbx_lpm_divide 2008:05:21:18:11:28:SJ cbx_lpm_mux 2008:05:19:10:30:36:SJ cbx_mgl 2009:01:29:16:12:07:SJ cbx_stratix 2008:09:18:16:08:35:SJ cbx_stratixii 2008:11:14:16:08:42:SJ cbx_stratixiii 2008:12:24:11:49:14:SJ cbx_util_mgl 2008:11:21:14:58:47:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463



//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix II" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=54 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  FRND_altbarrel_shift_isf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FRND_altbarrel_shift_isf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 284 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FRND_altfp_convert_q7q
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [53:0]   wire_altbarrel_shift7_result;
	...
	reg	sign_input_reg4;
	reg	underflow_reg;
	wire  [15:0]   wire_add_sub10_result;
	wire  [7:0]   wire_add_sub4_result;
	wire  [5:0]   wire_add_sub5_result;
	wire  wire_add_sub8_cout;
	wire  [30:0]   wire_add_sub8_result;
	wire  wire_add_sub9_cout;
	wire  [14:0]   wire_add_sub9_result;
	wire  wire_cmpr1_aeb;
	wire  wire_cmpr1_agb;
	wire  wire_cmpr2_aeb;
	wire  wire_cmpr3_alb;
	...
	FRND_altbarrel_shift_isf   altbarrel_shift7
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	.result(wire_altbarrel_shift7_result));
	// synopsys translate_off
	initial
		added_power2_reg = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   max_shift_reg <= wire_cmpr6_agb;
	// synopsys translate_off
	initial
		nan_reg = 0;
	// synopsys translate_on
	...
	defparam
		...
		add_sub10.lpm_width = 16,
		add_sub10.lpm_type = "lpm_add_sub",
		add_sub10.lpm_hint = "ONE_INPUT_IS_CONSTANT=YES";
	...
	assign
		add_1_cout_w = ((wire_add_sub8_cout & add_1_w) & (~ sign_input_reg3)),
		...
		guard_bit_w = wire_altbarrel_shift7_result[23],
		...
		integer_post_round = wire_add_sub8_result,
		...
		inv_add_1_adder1_w = wire_add_sub9_result,
		inv_add_1_adder2_w = (({16{(~ wire_add_sub9_cout)}} & inv_integer[30:15]) | ({16{wire_add_sub9_cout}} & wire_add_sub10_result)),
		inv_integer = (~ integer_rounded_reg),
		lbarrel_shift_result_w = wire_altbarrel_shift7_result,
		...
		round_bit_w = wire_altbarrel_shift7_result[22],
		...
		sticky_bus = wire_altbarrel_shift7_result[21:0],
...
endmodule //FRND_altfp_convert_q7q
//VALID FILE
...
`endif
	...
	FRND_altfp_convert_q7q	FRND_altfp_convert_q7q_component (
				.dataa (dataa),
				.clk_en (clk_en),
				.clock (clock),
				.aclr (aclr),
