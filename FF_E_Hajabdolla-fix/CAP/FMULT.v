...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix II" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab nan overflow result underflow zero
...
`endif
	...
	assign
		...
		zero = zero_ff;
endmodule //FMULT_altfp_mult_m7n
//VALID FILE
...
module FMULT (
	...
	FMULT_altfp_mult_m7n	FMULT_altfp_mult_m7n_component (
				.dataa (dataa),
				.datab (datab),
				.clk_en (clk_en),
				.aclr (aclr),
